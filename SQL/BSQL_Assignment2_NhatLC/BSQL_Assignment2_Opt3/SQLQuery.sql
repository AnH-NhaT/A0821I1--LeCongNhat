...
alter table Movie
add foreign key (Genre) references Genre(GenreID)  
...
values (1,'Nguyen Van A',22,2000.0000,'VN'),
		(2,'Nguyen Van B',22,3000.0000,'VN'),
		(3,'Nguyen Van C',22,4000.0000,'VN'),
		(4,'Nguyen Van D',22,5000.0000,'VN'),
		(5,'Nguyen Van E',22,1000.0000,'VN')
